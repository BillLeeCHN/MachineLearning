...
def learn(R_table, Q_table, E_table, s, a, s_, a_):
...
#    E_table[s, a] += 1
    ...
    E_table[s, :] = 0
    E_table[s, a] = 1
    # matrix operation element_wise
    # update Q_table each step
    Q_table += ALPHA * error * E_table
    # decay eligibility table each step
    E_table *=  GAMMA * LAMBDA
...
def QLearning():
    for i in range(EPISODES):
        ...
        while not is_terminated:
            ...
            # 最关键部分
            learn(R_table, Q_table, E_table, s, a, s_, a_)
